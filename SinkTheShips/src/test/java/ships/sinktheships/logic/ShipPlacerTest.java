...
public class ShipPlacerTest {
    ...
    public void shipDoesNotCollideWithPlayersOtherShipsWorksWhenCollision() {
        ...
        Ship testShip1 = new Ship(3, 1, 1, 0);
        Ship testShip2 = new Ship(4, 1, 1, 0);
    ...
    public void shipDoesNotCollideWithPlayersOtherShipsWorksWhenNoCollision() {
        Player player = new Player("Keijo", 0);
        Ship testShip1 = new Ship(3, 1, 1, 0);
        Ship testShip2 = new Ship(4, 2, 1, 0);
        player.addToFleet(testShip1);
    ...
    public void shipIsInRangeWorksWhenInRange() {
        Player player = new Player("Keijo", 0);
        Ship testShip = new Ship(3, 1, 1, 0);
    ...
    @Test
    public void shipFitsInWithPlayersOtherShipsAndGridWorksWhenNoOtherShips() {
        Player player = new Player("Keijo", 0);
        Ship testShip = new Ship(3, 1, 1, 0);
        placer.addShip(testShip);
    ...
    @Test
    public void shipFitsInWithPlayersOtherShipsAndGridWorksWhenNoCollision() {
        Player player = new Player("Keijo", 0);
        Ship testShip1 = new Ship(3, 1, 1, 0);
        Ship testShip2 = new Ship(3, 2, 1, 0);
        player.addToFleet(testShip1);
        placer.addShip(testShip2);
        assertEquals(true, placer.shipFitsInWithPlayersOtherShipsAndGrid(player));
    }
    ...
    @Test
    public void shipFitsInWithPlayersOtherShipsAndGridWorksWhenoutsideOdGrid() {
    ...
    @Test
    public void shipFitsInWithPlayersOtherShipsAndGridWorksWhenShipsOverlapWithAnAngle() {
        Player player = new Player("Keijo", 1);
        Ship testShip1 = new Ship(3, 1, 1, 0);
        Ship testShip2 = new Ship(3, 1, 1, 90);
